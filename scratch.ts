...
check('already-migrated 83', analyze('835123456').reason, 'already-migrated');
...
check('8-digit junk', analyze('82345678').reason, 'invalid');
...
check('00220 display', analyze('00220 3123456').display, '00220 835123456');
...
check('QCell migration', analyze('3123456').national9, '835123456');
